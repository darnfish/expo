...
export default class Camera extends React.Component<CameraProps> {
   ...
   *
   * > On native platforms, the local image URI is temporary. Use [`FileSystem.copyAsync`](filesystem/#filesystemcopyasyncoptions) to make a permanent copy * > of the image.
   */
